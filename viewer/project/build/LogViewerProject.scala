...
class LogViewerProject(info: ProjectInfo) extends DefaultProject(info){
  ...
  //val scalaQuery = "org.scalaquery" % "scalaquery" % "0.9.0" from 
"http://scala-tools.org/repo-releases/org/scalaquery/scalaquery_2.8.0/0.9.0/scalaquery_2.8.0-0.9.0.jar"
