...
class MMNSimulator
	...
	def average_waittime()
		return @people.inject(0){ |r,i| r += i.log[:wait_time]} / @people.size
	end
	
	attr_accessor :desks, :arrival_dist, :events, :waiting, :people
...
if $0 == __FILE__ then
	a = MMNSimulator.new(3.5, [Desk.new(3.0), Desk.new(4.0)], 50)
